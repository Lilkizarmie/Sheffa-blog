...
<section class="pt-100 pb-65 bg-brand-4 popular-categories">
    <div class="container">
        ...
        <div class="row carousel-6-columns  wow fadeIn  animated">
            ...
            <div class="col">
                <div class="border-radius-10 position-relative category-thumb thumb-overlay"
                    style="background-image: url({{ RvMedia::getImageUrl($category->image->meta_value[0], 'thumb', false, RvMedia::getDefaultImage()) }}">
