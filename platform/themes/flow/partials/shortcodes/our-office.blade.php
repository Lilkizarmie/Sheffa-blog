                            ...
                            <div class="post-card-1 border-radius-10 hover-up">
                                <div class="post-thumb thumb-overlay img-hover-slide position-relative" style="background-image: url({{ RvMedia::getImageUrl($item[3]['value'], null, false, RvMedia::getDefaultImage()) }})">
                                    <div class="post-meta-1 mb-20">
                                        <span class="tag-category bg-success shadown-1 text-dark button-shadow hover-up-3">{!! clean($item[0]['value']) !!}</span>
                                    </div>
                                </div>
                                <div class="post-content p-30">
                                    <div class="post-card-content">
                                        <h5 class="post-title mb-15">
                                            <a href="#">{!! clean($item[1]['value']) !!}</a>
                                        </h5>
                                        <p class="font-md">{!! clean($item[2]['value']) !!}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
